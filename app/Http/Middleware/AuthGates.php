...
class AuthGates
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        //Batch gate 
        Gate::define('batch_access', function (User $user) {
            return $user->role_id == 1;
        });
        Gate::define('batch_create', function (User $user) {
            return $user->role_id == 1;
        });
        Gate::define('batch_edit', function (User $user) {
            return $user->role_id == 1;
        });
        Gate::define('batch_show', function (User $user) {
            return $user->role_id == 1;
        });
        Gate::define('batch_delete', function (User $user) {
            return $user->role_id == 1;
        });
