    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.options.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required" for="option_type">Option Type </label>
                        <select class="form-control select2"  name="choice_type" id="choice_type" >
                ...
                <div class="form-group">
                    ...
                    <textarea type="hidden" class="form-control {{ $errors->has('choice_text') ? 'is-invalid' : '' }}" name="choice_text" id="choice_text" >{{ old('choice_text') }}</textarea>
