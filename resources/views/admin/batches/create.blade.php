...
<x-admin-layout>
    ...
    <div class="card">
        ...
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('titles.batch.title_singular') }}
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.batches.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('batch_label') ? 'is-invalid' : '' }}" type="text" name="batch_label" id="batch_label" value="{{ old('batch_label', '') }}" >
